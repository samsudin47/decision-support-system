...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    //   // Send login successfull, redirect to MainPage
    //   const response = await axios.post("http://localhost:3000/dashboards", { username, password });

    //   // If send login successfull, redirect to Dashboards
    ...
    //   setErrorMessage("Your Username and Password are incorret");
    // }
  };
                  ...
                  <div className="d-flex justify-content-center">
                    <form onSubmit={handleSubmit} className="w-75 p-3 m-3 shadow rounded-3 bg-light">
                      ...
                      <div className="mb-3">
                        ...
                        <input type="text" id="inputUsername" value={username} onChange={(e) => setUsername(e.target.value)} className="form-control" placeholder="Username" />
                        ...
                        <span className="d-flex justify-content-center p-2">
                          <Link to={"/register"} className="text-dark">
                            Belum punya akun? <span className="text-danger">Daftar terlebih dulu</span>
                          </Link>
                        </span>
                      </div>
                    </form>
